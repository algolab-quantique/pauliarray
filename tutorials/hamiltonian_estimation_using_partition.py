...
scheme_scenarios = [
    (
        QiskitSamplerEstimator(BackendSamplerV2(backend=AerSimulator())),
        partition_general_commutating,
...
for scheme_scenario in scheme_scenarios:
    ...
    estimator, partition_fct, diag_fct = scheme_scenario
    ...
    hamiltonian_expectation_value, hamiltonian_std = estimation_scheme.estimate_on_state_with_std(state_circuit)

    t2 = time.time()

    print(t1 - t0, t2 - t1, t2 - t0)
    print(hamiltonian_expectation_value, hamiltonian_std)
